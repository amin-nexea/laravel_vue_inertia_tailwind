...
const menuGroups = ref([
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        label: 'Pages',
        href: '#',
        children: [{ label: 'Settings', href: '/pages/settings' }]
      }
    ]
  },
  {
    ...
    menuItems: [
      {
        ...
        label: 'Charts',
        href: '#',
        children: [{ label: 'Basic Chart', href: '/charts/basic-chart' }]
      },
      {
        icon: `<svg
                  class="fill-current"
  ...
  <aside
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
      ...
      <div
        ...
        <Link href="https://tailadmin.com/pricing" target="_blank" rel="nofollow"
